import warnings
from streaming_llm.h2o_llama_attention import H2OLlamaAttention

from streaming_llm import StreamingLlama,load
...
def main(args):
    ...
    model, tokenizer = load(model_name_or_path, args.enable_streaming_with_H2O)
