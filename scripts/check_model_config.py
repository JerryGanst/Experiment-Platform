...
def check_model_config():
    ...
    try:
        ...
        # 检查路径类型
        if current_path.startswith("C:/Users/") or current_path.startswith("C:\\Users\\"):
            print("❌ 警告：检测到硬编码的Windows用户路径！")
            print("   请使用以下方法之一修复：")
            print("   1. 设置环境变量 HACE_MODEL_PATH")
            print("   2. 将模型放入 ./models/ 目录") 
            print("   3. 将模型放入 ~/models/ 目录")
            return False
...
def show_setup_guide():
    ...
    print("\n1️⃣ 环境变量设置 (推荐):")
    print("   Linux/macOS:")
    print("   export HACE_MODEL_PATH='/path/to/your/models/mistral-7b-instruct-v0.3'")
    print("\n   Windows:")
    print("   set HACE_MODEL_PATH=D:\\AI\\models\\mistral-7b-instruct-v0.3")
