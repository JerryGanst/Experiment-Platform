...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pref_mode", default="reverse_disp", help="HACE pref mode: reverse | reverse_disp")
...
def main() -> None:
    ...
    data_files = {"test": str(ROOT / "data" / f"{args.dataset}.jsonl")}
    data = load_dataset("json", data_files=data_files, split="test")
    ...
    print(f"  Pref Mode: {args.pref_mode}")
